...
struct board_info_type board_info[NUM_OF_BOARDS] = {
    ...
    {3096,  0         , LVL_IMPL + 1, LVL_IMPL + 1, LIB_ETC"board.social", 0}, /* old board, only for the curious */
    {3093,  0         , 0, LVL_IMMORT, LIB_ETC"board.idea.mort", 0},
    {3094,  0         , 0, LVL_IMMORT, LIB_ETC"board.bugs.mort", 0},
    {3038,  0         , 0, LVL_IMMORT, LIB_ETC"board.quest.mort", 0},
    {1299,  LVL_IMPL  , LVL_IMPL, LVL_IMPL, LIB_ETC"board.imp", 0},
    {10090, LVL_IMMORT, LVL_IMMORT, LVL_CIMP, LIB_ETC"board.area", 0},
    {10091, 25        , 25, LVL_GRGOD, LIB_ETC"board.playtest", 0},
    {10092, LVL_IMMORT, LVL_IMMORT, LVL_IMPL, LIB_ETC"board.code", 0},
    {10093, LVL_IMMORT, LVL_IMMORT, LVL_IMPL, LIB_ETC"board.logistics", 0},
    {10094, LVL_IMMORT, LVL_IMMORT, LVL_IMPL, LIB_ETC"board.quest", 0},
    {1211,  LVL_IMMORT, 0, LVL_CIMP, LIB_ETC"board.vote", 0},
    {1212,  0         , 99, LVL_GOD, LIB_ETC"board.rep", 0},
    {1213,  0         , 0, LVL_IMMORT, LIB_ETC"board.auction.mort", 0},
	{1244,	0		  , LVL_IMPL,	LVL_IMPL, LIB_ETC"board.changes.mort", 0}
};
