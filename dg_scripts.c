...
int find_eq_pos_script(char *arg)
{
  ...
  struct eq_pos_list {
    ...
    int where;
        ...
        {"light",    WEAR_LIGHT   },
        {"wield",    WEAR_WIELD   },
        {"rimplant", WEAR_IMPLANT_R},
        {"limplant", WEAR_IMPLANT_L},
        {"implantr", WEAR_IMPLANT_R},
        {"implantl", WEAR_IMPLANT_L},
        {"neck1",    WEAR_NECK_1  },
        {"neck2",    WEAR_NECK_2  },
        {"neckl",    WEAR_NECK_1  },
        {"neckr",    WEAR_NECK_2  },
        ...
        {"face",     WEAR_FACE },
        {"nose",     WEAR_RING_NOSE },
        {"nosering", WEAR_RING_NOSE },
        {"ears",     WEAR_EARS },
        {"earl",     WEAR_RING_EAR_L },
        {"earr",     WEAR_RING_EAR_R },
        {"lear",     WEAR_RING_EAR_L },
        {"rear",     WEAR_RING_EAR_R },
        {"ringerl",  WEAR_RING_FIN_L },
        {"fingerr",  WEAR_RING_FIN_R },
        {"nipplel",  WEAR_RING_NIP_L },
        {"nippler",  WEAR_RING_NIP_R },
        {"expansion",WEAR_EXPANSION },
        {"floating", WEAR_FLOATING_NEARBY },
        {"none",     -1           }
  };
...
int can_wear_on_pos(struct obj_data *obj, int pos)
{
  switch (pos) {
    ...
    case WEAR_RING_FIN_L: return CAN_WEAR(obj, ITEM_WEAR_FINGER);
    case WEAR_NECK_1:
