    ...
    if (mode) {
      switch (time_info.hours) {
         case 5:
            ...
            send_to_outdoor("The light raises through a radioactive haze.\r\n");
            break;
         case 6:
         ...
         case 21:
            ...
            send_to_outdoor("The world around you is covered in a haze of darkness.\r\n");
            break;
         case 22:
...
static void weather_change(void)
{
  ...
  switch (change) {
    case 0:
      break;
    case 1:
      send_to_outdoor("Radioactive clouds move quickly overhead.\r\n");
      weather_info.sky = SKY_CLOUDY;
      break;
    case 2:
      send_to_outdoor("Drops of acidic rain hit the ground.\r\n");
      weather_info.sky = SKY_RAINING;
      break;
    case 3:
      send_to_outdoor("The sun begins to peek through the clouds.\r\n");
      weather_info.sky = SKY_CLOUDLESS;
      break;
    case 4:
      send_to_outdoor("Black bolts of lightning streak across the green patched sky.\r\n");
      weather_info.sky = SKY_LIGHTNING;
      break;
    case 5:
      send_to_outdoor("The radioactive storm clears up and the harsh UV rays pierce your skin again.\r\n");
      weather_info.sky = SKY_CLOUDY;
      break;
    case 6:
      send_to_outdoor("The storm stops.\r\n");
      weather_info.sky = SKY_RAINING;
      break;
    default:
      break;
