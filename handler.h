...
void extract_char_final_death(struct char_data *ch);
void extract_pending_chars_death(void);
// Fighting Characters TAG: NEWFIGHT
...
#define FIND_OBJ_ROOM      (1 << 2)
#define FIND_OBJ_WORLD     (1 << 3)
#define FIND_OBJ_INV       (1 << 4)
...
// extra defines for room_update in limits.c
#define DO_NOT_BURN 0
#define DO_BURN     1
