...
#define LIB_STORAGE	 ":storage:"// Storage units - Gahan
#define LIB_DEATHOBJ ":deathobj:"// Saving bodybags to prevent eq loss from Crashing - Gahan
#define SLASH		":"
...
#define LIB_HOUSE	"house/"
#define LIB_PLRFILES    "plrfiles/"
#define LIB_BIONICS         "plrbionics/"
#define LIB_STORAGE			"storage/"
#define LIB_DEATHOBJ		"bodybags/"
#define LIB_VEHICLE 	"vehicles"
#define SLASH		"/"
#else
...
#define NMOTD_FILE          LIB_TEXT"nmotd"         /* newbie message                           */
...
#define SOCMESS_FILE_NEW LIB_MISC"socials"  /* messages for social acts with aedit patch*/
...
#define LOG_SYSLOG1         PREFIX_LOGFILE"syslog.1"
#define LOG_SYSLOG2         PREFIX_LOGFILE"syslog.2"
#define LOG_SYSLOG3         PREFIX_LOGFILE"syslog.3"
#define LOG_SYSLOG4         PREFIX_LOGFILE"syslog.4"
#define LOG_SYSLOG5         PREFIX_LOGFILE"syslog.5"
#define LOG_SYSLOG6         PREFIX_LOGFILE"syslog.6"
#define LOG_SYSLOG7         PREFIX_LOGFILE"syslog.7"
#define LOG_SYSLOG8         PREFIX_LOGFILE"syslog.8"
#define LOG_SYSLOG9         PREFIX_LOGFILE"syslog.9"
#define LOG_SYSLOG10        PREFIX_LOGFILE"syslog.10"
#define LOG_LAST            PREFIX_LOGFILE"syslog.last"
#define LOG_QP              PREFIX_LOGFILE"qp"
#define LOG_SABER           PREFIX_LOGFILE"saber"
#define LOG_WARNINGS        PREFIX_LOGFILE"warnings"
#define LOG_DTS             PREFIX_LOGFILE"dts"
/**/
...
#define RAINBOW_FILE        LIB_ETC"rainbow"        /* Current counter of rainbow tokens        */
#define RADIO_FILE          LIB_ETC"radio"          /* Radio stations -- is this where they go? */
...
struct gain_data
{
	int playerid;					// Player IDNUM
	int playerlevel;
	struct skill_data *use;		    // Linked list for struct below
	struct gain_data *next;
};

struct skill_data
{
	int skillid;					// Macro assigned number for skill/psionic
	int type;						// 0 for Psionics, 1 for Skills
	int totalgained;				// Amount of exp gained in total so far
	int timesused;					// Amount of times the skill is used
	struct skill_data *next;
};
...
void update_skilluse(int skillid, int skilltype, struct gain_data *glist, int exp, struct char_data *ch);
...
extern struct gain_data *global_gain;
