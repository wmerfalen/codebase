...
struct shop_data {
    ...
    int bankAccount;            /* Store all units over 15000 (disabled)*/
...
#define MAX_SHOP_OBJ    300     /* "Soft" maximum for list maximums     */
...
#define TRADE_NOMERCENARY   (1 << 0)
#define TRADE_NOCRAZY       (1 << 1)
#define TRADE_NOSTALKER     (1 << 2)
#define TRADE_NOBORG        (1 << 3)
#define TRADE_NOHIGHLANDER  (1 << 4)
#define TRADE_NOPREDATOR    (1 << 5)
#define TRADE_NOCALLER      (1 << 6)
...
#define NOTRADE_MERCENARY(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMERCENARY))
#define NOTRADE_CRAZY(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCRAZY))
#define NOTRADE_STALKER(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOSTALKER))
#define NOTRADE_BORG(i)         (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOBORG))
#define NOTRADE_HIGHLANDER(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOHIGHLANDER))
#define NOTRADE_PREDATOR(i)     (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPREDATOR))
#define NOTRADE_CALLER(i)     (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCALLER))
