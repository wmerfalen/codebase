...
#define MTRIG_QUEST			   (1 << 20)	 /* trigger based on quest     */
...
#define OTRIG_ENTER           (1 << 12)    /* character trys to remove obj */
#define OTRIG_LOAD             (1 << 13)    /* the object is loaded        */
#define OTRIG_THROW           (1 << 14)    /* character trys to remove obj */
...
#define MOB_ID_BASE	  500000  /* 500000 player IDNUMS should suffice */
#define ROOM_ID_BASE    1500000 /* 1000000 Mobs */
#define OBJ_ID_BASE     1850000 /* 350000 Rooms */
