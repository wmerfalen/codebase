...
static void medit_disp_damage_types(struct descriptor_data *d);
...
static void init_mobile(struct char_data *mob)
{
    ...
    GET_HIT(mob) = GET_PSI(mob) = 1;
    GET_MAX_PSI_PTS(mob) = GET_MAX_MOVE(mob) = 100;
    GET_NDD(mob) = GET_SDD(mob) = 1;
    GET_WEIGHT(mob) = 200;
    GET_HEIGHT(mob) = 198;

    mob->real_abils.str = mob->real_abils.intel = mob->real_abils.pcn = 11;
    mob->real_abils.dex = mob->real_abils.con = mob->real_abils.cha = 11;
    mob->aff_abils = mob->real_abils;

    GET_SAVE(mob, SAVING_NORMAL) = 0;
    GET_SAVE(mob, SAVING_POISON) = 0;
    GET_SAVE(mob, SAVING_DRUG) = 0;
    GET_SAVE(mob, SAVING_FIRE) = 0;
    GET_SAVE(mob, SAVING_COLD) = 0;
	GET_SAVE(mob, SAVING_ELECTRICITY) = 0;
	GET_SAVE(mob, SAVING_EXPLOSIVE) = 0;
	GET_SAVE(mob, SAVING_PSIONIC) = 0;
	GET_SAVE(mob, SAVING_NONORM) = 0;
...
static void medit_disp_damage_types(struct descriptor_data *d)
{
  ...
  for (i = 0; i < MAX_DMG; i++)
	  write_to_output(d, "%s%2d%s) %s\r\n", grn, i, nrm, damagetype_bits[i]);
  write_to_output(d, "Enter damage type : ");
}
...
static void medit_disp_menu(struct descriptor_data *d)
{
  ...
  write_to_output(d,
	  ...
	  grn, nrm, yel, damagetype_bits[(int)GET_DAMTYPE(mob)],
	  grn, nrm,
	  grn, nrm, cyn, flags,
	  grn, nrm, cyn, flag2,
        grn, nrm, cyn, npc_class_types[(int)GET_MOB_CLASS(mob)],
        grn, nrm, cyn, GET_MOB_ATTACKS(mob),
...
static void medit_disp_stats_menu(struct descriptor_data *d)
{
  ...
  sprintf(buf, "(HP range @y%d@n to @y%d@n)", GET_HIT(mob) + GET_MOVE(mob), (GET_HIT(mob) * GET_PSI(mob)) + GET_MOVE(mob));

  /* Top section - standard stats */
    write_to_output(d,
        "-- Mob Number:  %s[%s%4d%s]%s\r\n"
        "%s1%s) Level:       %s[%s%4d%s]%s\r\n"
		"%s2%s) Team:        %s[%s%s%s]%s\r\n"
        "%s3%s) %sAuto Set Stats (based on level)%s\r\n"

        "Mob Health                  Mob Attack\r\n"
        "%s8%s) HP Num Dice:  %s[%s%6d%s]%s   %s6%s) BHD Num Dice:  %s[%s%6d%s]%s\r\n"
        "%s9%s) HP Size Dice: %s[%s%6d%s]%s   %s7%s) BHD Size Dice: %s[%s%6d%s]%s\r\n"
        "%sA%s) HP Bonus:     %s[%s%6d%s]%s   %s5%s) Damroll:       %s[%s%6d%s]%s\r\n"
        "                            %s4%s) Hitroll:       %s[%s%6d%s]%s\r\n\r\n"
        "%-*s(Dam range %s%d%s to %s%d%s)\r\n\r\n"

        "%sB%s) AC: %s[%s%6d%s]%s,  %sC%s) Exp: %s[%s%10d%s]%s  "
        "%sD%s) Units: %s[%s%10d%s]%s\r\n",

        cyn, yel, OLC_NUM(d), cyn, nrm,
        cyn, nrm, cyn, yel, GET_LEVEL(mob), cyn, nrm,
		cyn, nrm, cyn, yel, teams[(int)GET_TEAM(mob)], cyn, nrm,
        cyn, nrm, cyn, nrm,
        cyn, nrm, cyn, yel, GET_HIT(mob), cyn, nrm,
        cyn, nrm, cyn, yel, GET_NDD(mob), cyn, nrm,
        cyn, nrm, cyn, yel, GET_PSI(mob), cyn, nrm,
        ...
        cyn, nrm, cyn, yel, GET_UNITS(mob), cyn, nrm
    );
    ...
    if (CONFIG_MEDIT_ADVANCED) {
        ...
        write_to_output(d,
			"%sF%s) Str: %s[%s%2d%s]%s       Saving Throws:\r\n"
            "%sG%s) Int: %s[%s%3d%s]%s      %sL%s) Normal        %s[%s%3d%s]%s\r\n"
            "%sH%s) Pcn: %s[%s%3d%s]%s      %sM%s) Poison        %s[%s%3d%s]%s\r\n"
            "%sI%s) Dex: %s[%s%3d%s]%s      %sN%s) Drug          %s[%s%3d%s]%s\r\n"
            "%sJ%s) Con: %s[%s%3d%s]%s      %sO%s) Fire          %s[%s%3d%s]%s\r\n"
            "%sK%s) Cha: %s[%s%3d%s]%s      %sP%s) Cold          %s[%s%3d%s]%s\r\n"
			"                   %sR%s) Electricity   %s[%s%3d%s]%s\r\n"
			"                   %sS%s) Explosive     %s[%s%3d%s]%s\r\n"
			"                   %sT%s) Psionic       %s[%s%3d%s]%s\r\n"
			"                   %sU%s) Nonorm        %s[%s%3d%s]%s\r\n",
            cyn, nrm, cyn, yel, GET_STR(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_INT(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_NORMAL), cyn, nrm,
            cyn, nrm, cyn, yel, GET_PCN(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_POISON), cyn, nrm,
            cyn, nrm, cyn, yel, GET_DEX(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_DRUG), cyn, nrm,
            cyn, nrm, cyn, yel, GET_CON(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_FIRE), cyn, nrm,
            cyn, nrm, cyn, yel, GET_CHA(mob), cyn, nrm,
            cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_COLD), cyn, nrm,
			cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_ELECTRICITY), cyn, nrm,
			cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_EXPLOSIVE), cyn, nrm,
			cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_PSIONIC), cyn, nrm,
			cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_NONORM), cyn, nrm
        );
    }
...
void medit_parse(struct descriptor_data *d, char *arg)
{
  ...
  case MEDIT_CONFIRM_SAVESTRING:
    ...
    break;
        ...
        case MEDIT_STATS_MENU:
            ...
            switch(*arg) {
                ...
                case '2':
                    ...
                    for (i = 0; *teams[i] != '\n'; i++)
                        write_to_output(d, "%s%2d%s) %s\r\n", grn, i, nrm, teams[i]);
                    write_to_output(d, "Enter new team: ");
                    break;
                case '3':  // Autoroll stats
        ...
        case MEDIT_CLASS:
            GET_MOB_CLASS(OLC_MOB(d)) = LIMIT(atoi(arg), 0, NUM_MOB_CLASSES - 1);
            break;

        case MEDIT_HITROLL:
            GET_HITROLL(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 5000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_DAMROLL:
            GET_DAMROLL(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 5000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_NDD:
            GET_NDD(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 15000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_SDD:
            GET_SDD(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 15000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_NUM_HP_DICE:
            GET_HIT(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 5000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_SIZE_HP_DICE:
            GET_PSI(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 5000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_ADD_HP:
            GET_MOVE(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 30000000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_AC:
            GET_AC(OLC_MOB(d)) = LIMIT(atoi(arg), 0, 10000);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_EXP:
            GET_EXP(OLC_MOB(d)) = LIMIT(atoi(arg), 0, MAX_MOB_EXP);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_UNITS:
            GET_UNITS(OLC_MOB(d)) = LIMIT(atoi(arg), 0, MAX_MOB_UNITS);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_STR:
            GET_STR(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_INT:
            GET_INT(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_PCN:
            GET_PCN(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_DEX:
            GET_DEX(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_CON:
            GET_CON(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_CHA:
            GET_CHA_ABIL(OLC_MOB(d)) = LIMIT(atoi(arg), 1, 30);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_NORMAL:
            GET_SAVE(OLC_MOB(d), SAVING_NORMAL) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_POISON:
            GET_SAVE(OLC_MOB(d), SAVING_POISON) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_DRUG:
            GET_SAVE(OLC_MOB(d), SAVING_DRUG) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_FIRE:
            GET_SAVE(OLC_MOB(d), SAVING_FIRE) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

        case MEDIT_COLD:
            GET_SAVE(OLC_MOB(d), SAVING_COLD) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;
		
		case MEDIT_ELECTRICITY:
            GET_SAVE(OLC_MOB(d), SAVING_ELECTRICITY) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

		case MEDIT_EXPLOSIVE:
            GET_SAVE(OLC_MOB(d), SAVING_EXPLOSIVE) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

		case MEDIT_PSIONIC:
            GET_SAVE(OLC_MOB(d), SAVING_PSIONIC) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;

		case MEDIT_NONORM:
            GET_SAVE(OLC_MOB(d), SAVING_NONORM) = LIMIT(atoi(arg), -100, 90);
            OLC_VAL(d) = TRUE;
            medit_disp_stats_menu(d);
            return;
        case MEDIT_POS:
            GET_POS(OLC_MOB(d)) = LIMIT(atoi(arg), 0, NUM_POSITIONS - 1);
            break;

        case MEDIT_DEFAULT_POS:
            GET_DEFAULT_POS(OLC_MOB(d)) = LIMIT(atoi(arg), 0, NUM_POSITIONS - 1);
            break;

        case MEDIT_ATTACK:
            GET_ATTACK(OLC_MOB(d)) = LIMIT(atoi(arg), 0, NUM_ATTACK_TYPES - 1);
            break;

		case MEDIT_DAMTYPE:
			GET_DAMTYPE(OLC_MOB(d)) = LIMIT(atoi(arg), 0, MAX_DMG -1);
			break;

        case MEDIT_LEVEL:
            GET_LEVEL(OLC_MOB(d)) = LIMIT(atoi(arg), 1, LVL_IMPL);
            break;
        case MEDIT_TEAM:
            GET_TEAM(OLC_MOB(d)) = MAX(0, MIN(8, atoi(arg)));
            break;
        case MEDIT_NUM_ATTACK:
            GET_MOB_ATTACKS(OLC_MOB(d)) = MAX(-1, MIN(20, atoi(arg)));
            break;
...
void medit_autoroll_stats(struct descriptor_data *d)
{
    ...
    GET_MOVE(OLC_MOB(d))    = mob_lev*1000;          /* hit point bonus         */
    GET_HIT(OLC_MOB(d))     = mob_lev*5;           /* number of hitpoint dice */
    GET_PSI(OLC_MOB(d))     = mob_lev*5;           /* size of hitpoint dice   */

    GET_NDD(OLC_MOB(d))     = mob_lev*1;   /* number damage dice 1-5  */
    GET_SDD(OLC_MOB(d))     = (mob_lev/6)+10;   /* size of damage dice 2-5 */
    GET_DAMROLL(OLC_MOB(d)) = mob_lev*3;           /* damroll (dam bonus) 0-5 */

    GET_HITROLL(OLC_MOB(d)) = mob_lev*5;           /* hitroll 0-10            */
    GET_EXP(OLC_MOB(d))     = mob_lev*2500;
    GET_UNITS(OLC_MOB(d))   = mob_lev*1000;
    GET_AC(OLC_MOB(d))      = mob_lev*5;   /* AC 94 to -80            */

    // 'Advanced' stats are only rolled if advanced options are enabled
    if (CONFIG_MEDIT_ADVANCED) {
        GET_STR(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25); /* 2/3 level in range 11 to 18 */
        GET_INT(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25);
        GET_PCN(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25);
        GET_DEX(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25);
        GET_CON(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25);
        GET_CHA_ABIL(OLC_MOB(d))     = LIMIT(5+(mob_lev/2), 1, 25);

        GET_SAVE(OLC_MOB(d), SAVING_NORMAL)   = mob_lev / 4;  /* All Saving throws */
        GET_SAVE(OLC_MOB(d), SAVING_POISON)    = mob_lev / 4;  /* set to a quarter  */
        GET_SAVE(OLC_MOB(d), SAVING_DRUG)  = mob_lev / 4;  /* of the mobs level */
        GET_SAVE(OLC_MOB(d), SAVING_FIRE) = mob_lev / 4;
        GET_SAVE(OLC_MOB(d), SAVING_COLD)  = mob_lev / 4;
		GET_SAVE(OLC_MOB(d), SAVING_ELECTRICITY)  = mob_lev / 4;
		GET_SAVE(OLC_MOB(d), SAVING_EXPLOSIVE)  = mob_lev / 4;
		GET_SAVE(OLC_MOB(d), SAVING_PSIONIC)  = mob_lev / 4;
		GET_SAVE(OLC_MOB(d), SAVING_NONORM)  = mob_lev / 4;
    }
