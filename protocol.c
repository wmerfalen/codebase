 ...
 * (eg changing 'psi' to 'blood' for vampires).  You could even allow players 
...
static const char s_Gauge2[]  = "\005\002Psi\002blue\002PSI\002PSI_MAX\006";
...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
   ...
   { eMSDP_PSI,	             "PSI",              NUMBER_READ_ONLY }, 
   { eMSDP_PSI_MAX,	         "PSI_MAX",      NUMBER_READ_ONLY }, 
   { eMSDP_WIMPY,            "WIMPY",            NUMBER_READ_ONLY }, 
   { eMSDP_PRACTICE,         "PRACTICE",         NUMBER_READ_ONLY }, 
   { eMSDP_MONEY,            "MONEY",            NUMBER_READ_ONLY }, 

   { eMSDP_QUESTPOINTS,      "QUESTPOINTS",      NUMBER_READ_ONLY }, 
   { eMSDP_PROGRESS,            "PROGRESS",            NUMBER_READ_ONLY }, 
   { eMSDP_TIER,            "TIER",            NUMBER_READ_ONLY }, 
   { eMSDP_FAME,            "FAME",            NUMBER_READ_ONLY }, 
   { eMSDP_PROGRESSPCNT,            "PROGRESSPCNT",            NUMBER_READ_ONLY }, 
   { eMSDP_CAN_CARRY_W,            "CAN_CARRY_W",            NUMBER_READ_ONLY }, 
   { eMSDP_IS_CARRYING_W,            "IS_CARRYING_W",            NUMBER_READ_ONLY }, 
   { eMSDP_IS_WEARING_W,            "IS_WEARING_W",            NUMBER_READ_ONLY }, 
   { eMSDP_ENCUMBRANCE,            "ENCUMBRANCE",            NUMBER_READ_ONLY }, 
   { eMSDP_GREEN_SHARDS,            "GREEN_SHARDS",            NUMBER_READ_ONLY }, 
   { eMSDP_BLUE_SHARDS,            "BLUE_SHARDS",            NUMBER_READ_ONLY }, 
   { eMSDP_BLACK_SHARDS,            "BLACK_SHARDS",            NUMBER_READ_ONLY }, 
   { eMSDP_AMMO,            "AMMO",            NUMBER_READ_ONLY }, 
   ...
   { eMSDP_PCN,              "PCN",              NUMBER_READ_ONLY }, 
   ...
   { eMSDP_PCN_PERM,         "PCN_PERM",         NUMBER_READ_ONLY }, 
